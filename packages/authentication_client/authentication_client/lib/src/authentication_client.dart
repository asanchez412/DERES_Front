...
/// Thrown during the register with email and password
/// process if a failure occurs.
/// {@endtemplate}
class RegisterWithEmailAndPasswordFailure extends AuthenticationException {
  /// {@macro register_with_email_and_password_failure}
  const RegisterWithEmailAndPasswordFailure(super.error);
}

/// {@template log_in_with_email_and_password_failure}
/// Thrown during the log in with email and password
/// process if a failure occurs.
/// {@endtemplate}
...
class LogInWithPhoneNumberFailure extends AuthenticationException {
  ...
  const LogInWithPhoneNumberFailure(super.error);
}

/// {@template log_in_with_phone_incorrect_code}
/// Thrown during the sign in with phone number.
/// {@endtemplate}
class LogInWithPhoneNumberIncorrectCode extends AuthenticationException {
  /// {@macro log_in_with_phone_incorrect_code}
  const LogInWithPhoneNumberIncorrectCode(super.error);
}
...
abstract class AuthenticationClient {
  ...
  /// Stream for [logInWithPhoneNumber] events
  Stream<PhoneVerificationEvent> get phoneVerificationEvents;
  ...
  /// Prequisite for [logInWithEmailAndPassword]
  ///
  ...
  /// Requires [registerWithEmailAndPassword]
  ///
  ...
  /// Logs in a user with [phoneNumber].
  /// Updates are emitted through the [phoneVerificationEvents] stream
  ///
  ...
  /// Logs in a user with the last saved verification id
  /// and the recived [smsCode]
  ///
  /// Throws a [LogInWithPhoneNumberIncorrectCode] if an exception occurs.
